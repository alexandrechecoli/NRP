...
int main(int argc, char *argv[])
{
    ...
    std::string file_path = "C:\\Users\\Usuario\\Documents\\Alexandre\\C++\\NurseRostering\\1-API\\build-API-Desktop_Qt_5_15_2_MinGW_64_bit-Debug\\debug\\instances\\instance.json";
    ...
    parse_json_to_csv(output_json,"out.csv");
